...
public class Main {
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("Qual é a valor da tabela do veiculo­ "+pergunta+"?");
			valorTabela = ler.nextDouble();
			
			System.out.println("Qual é a cor do veiculo "+pergunta+"?");
			cor = ler.next();
			
			System.out.println("Qual é o combustivel do veiculo "+pergunta+"?");
